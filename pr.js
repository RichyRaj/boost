function renderAppsProductive(cData) {
    console.log(cData)
    console.log(Object.keys(cData));
    console.log(Object.values(cData));
    var Chart = require('chart.js');

    var ct = document.getElementById('appsPr'),
        ...
        data: {
            labels: appNames,
            datasets: [{
              label: "Apps that were used when productive (usage in minutes)",  
          ...
          options: {
            title: {
              display: true,
              text: 'Apps that were used when productive (usage in minutes)',
              fontColor: '#cccccc',              
            }
          }        
    });
    ...
    ipc.on('dataReady', (e, data) => {
        switch(data.type) {
            case 'todayPrApps':
                ...
                console.log(data);                
                renderAppsProductive(data.data.prList);
              break;
            default:
